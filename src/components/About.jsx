...
const About = () => {
  ...
  return (
    <>
    {/* Section "Appointment" avec animation */}
        ...
        <div className="content animate-on-scroll" data-delay="0.4">
          ...
          <div className="social-resume-container d-flex gap-4 mt-5">
            <div className="animate-on-scroll" data-delay="0.6">
              ...
              >
                <i className="fab fa-linkedin me-3" style={{ fontSize: '24px' }}></i>{' '}
                LinkedIn
              </a>
            </div>
            ...
            <div className="animate-on-scroll" data-delay="0.6">
              <a
                ...
                style={{ padding: '10px 20px', fontSize: '18px' }}
              >
                <i className="fab fa-facebook me-3" style={{ fontSize: '24px' }}></i>{' '}
                Facebook
              </a>
            </div>
            ...
            <div className="animate-on-scroll" data-delay="0.6">
              ...
              >
                <i
                  className="fas fa-file-pdf me-4"
                  style={{ fontSize: '24px' }}
                ></i>
                <span>Resume (CV)</span>
              </a>
